...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/09 20:37:08 by ivanderw          #+#    #+#             */
/*   Updated: 2023/10/09 20:41:47 by ivanderw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//parse4.c
int					can_poke_texture_data(t_parsed_data *data, \
						t_type_and_string pair);
void				poke_texture_data(t_parsed_data *data, \
						t_type_and_string pair);

//parse5.c
int					is_valid_line_colour(char *line);
t_char_and_rgb		line_to_colour_data(char *line);
int					can_poke_colour_data(t_parsed_data *data, \
						t_char_and_rgb rgb);
